...
import { configureStore as sagaConfigureStore } from "../../redux-saga-example/src/store";
import Api from "./Api";

const implementations = [
  { configureStore, adapterName: 'redux-observable' },
  { configureStore: sagaConfigureStore, adapterName: 'redux-saga' }
]
jest.mock("./Api");

const verifyContract = ({configureStore, adapterName}) => {
  describe(`loginFlow contract (using ${adapterName})`, () => {
...
implementations.forEach(verifyContract);
